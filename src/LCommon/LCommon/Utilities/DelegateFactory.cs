...
namespace LCommon.Utilities
{
    ...
    public class DelegateFactory
    {
        ...
        public static D CreateDelegate<D>(MethodInfo methodInfo, Type[] parameterTypes) where D : class
        {
            ...
            var dynamicMethod = new DynamicMethod(methodInfo.Name, MethodAttributes.Static | MethodAttributes.Public, CallingConventions.Standard, methodInfo.ReturnType, parameterTypes, typeof(object), true) { InitLocals = false };
            ...
            public void LoadArgument(int argumentIndex)
            {
                switch(argumentIndex)
                {
                    ...
                    default:
                        ...
                        {
                            this._ilGenerator.Emit(OpCodes.Ldarg_S, argumentIndex);
                        }
                        break;
                }
            }
